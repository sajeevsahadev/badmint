-- v111_get_tournaments_hide_drafts_from_public
-- Non-admins must not see draft/cancelled or private tournaments in the list.
-- App admins (the only ones who create tournaments) still see everything.
