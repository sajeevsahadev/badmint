...
const routes = [
  ...
  { path: '/tournament/:id/register', component: () => import('../views/TournamentRegister.vue'), meta: { public: true } },
  { path: '/tournament/:id/manage', component: () => import('../views/ManageTournament.vue') },
  { path: '/t/:code',               component: () => import('../views/TournamentPublic.vue'),    meta: { public: true } },
