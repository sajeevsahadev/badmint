...
const story = [
  ...
  },
  {
    ...
    text: 'Court fee, shuttlecocks, water — someone always pays and someone always forgets. Split Pay divides every cost equally, and the shared Wallet lets players chip in upfront so nobody chases anybody.',
